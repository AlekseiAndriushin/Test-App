...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"checkingElementHit\": () => (/* binding */ checkingElementHit)\n/* harmony export */ });\nvar takeContentBlock = document.querySelector('.content');\nvar takeCard = document.querySelector('.components__card');\nvar checkingElementHit = function checkingElementHit() {\n  function onClickContentBlock(e) {\n    if (e.button === 2) {\n      alert('Меню для списка компаний');\n    }\n  }\n\n  function onClickCard(event) {\n    if (event.which === 3 && event.target.nodeName === 'SPAN') {\n      alert('Меню для карточки');\n    }\n  }\n\n  takeContentBlock.addEventListener('mousedown', onClickContentBlock);\n  takeCard.addEventListener('mousedown', onClickCard);\n};\n\n//# sourceURL=webpack:///./src/checkingElementHit.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"outputSelectedCompanies\": () => (/* binding */ outputSelectedCompanies)\n/* harmony export */ });\n/* harmony import */ var _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/toConsumableArray */ \"./node_modules/@babel/runtime/helpers/esm/toConsumableArray.js\");\n\nvar findButton = document.querySelector('.findListButton');\nvar outputSelectedCompanies = function outputSelectedCompanies() {\n  var componentsElem = document.getElementById('components');\n\n  function findList() {\n    var selectedCards = document.querySelectorAll('.changedCard');\n\n    if (selectedCards.length && componentsElem.getElementsByClassName('changedCard')) {\n      var findCompanyName = (0,_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(selectedCards);\n\n      console.clear();\n      findCompanyName.forEach(function (child) {\n        console.log(child.firstChild.textContent);\n      });\n    } else {\n      console.log('тут пусто');\n    }\n  }\n\n  findButton.addEventListener('click', findList);\n};\n\n//# sourceURL=webpack:///./src/outputSelectedCompanies.js?");

/***/ }),

/***/ "./src/queries/footerQuerys.js":
/*!*************************************!*\
  !*** ./src/queries/footerQuerys.js ***!
  \*************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"getUser\": () => (/* binding */ getUser)\n/* harmony export */ });\nvar header = document.querySelector('#header');\nfunction getUser(profileData) {\n  if (profileData.avatar_url && profileData.name && profileData.followers) {\n    var click = function click() {\n      window.open(profileData.html_url);\n    };\n\n    var heading = document.createElement('span');\n    var headingTextNode = document.createTextNode(\"Github profile: \".concat(profileData.name));\n    heading.appendChild(headingTextNode);\n    heading.addEventListener('click', click);\n    var image = document.createElement('img');\n    image.src = profileData.avatar_url;\n    image.width = 100;\n    var followers = document.createElement('span');\n    var followersTextNode = document.createTextNode(\"Number of my subscribers: \".concat(profileData.followers));\n    followers.appendChild(followersTextNode);\n    header.appendChild(heading);\n    header.appendChild(image);\n    header.appendChild(followers);\n  } else {\n    return;\n  }\n}\n\n//# sourceURL=webpack:///./src/queries/headerQuery.js?");
